...
namespace YilanOyunu
{
    public partial class Form1 : Form
    {
        ...
        {
            // hedef, kuyruguna denk geliyorsa sorun yok.
        ...
        private void YilaniOlustur()
        {
            yilan = new List<Point>()
            {
                ...
                new Point(boyut / 2 - 1, boyut / 2), // gövde bogum
                new Point(boyut / 2 - 2, boyut / 2) // gövde bogum (kuyruk)
            };
        }
        ...
        void BogumCiz(Graphics g, Point bogum, Color renk)
        {
            ...
            int genislik = pnlSaha.Width / boyut;
            int yukseklik = pnlSaha.Height / boyut;
            int x = bogum.X * genislik;
            int y = bogum.Y * yukseklik;
